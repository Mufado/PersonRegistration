...
public static class DbSeeder
{
    ...
    private static void SeedPeople(AppDbContext context)
    {
        ...
        context.People.AddRange(
            new Person { Name = "Ana Souza", Cpf = "11144477735", BirthDate = new DateOnly(1990, 5, 12), BirthSex = BirthSex.Female, Email = "ana@exemplo.com", BirthPlace = "Fortaleza", Nationality = "Brasileira", CreatedAt = now, UpdatedAt = now },
